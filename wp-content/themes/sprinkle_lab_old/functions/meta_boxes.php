...
add_action('add_meta_boxes', function($post_type){
	...
	if( $post_type == 'video' ) {
		...
		add_meta_box( 'video_meta', 'Video Meta', function($post){
			...
			$what_we_did = isset($video_meta['what_we_did']) && is_array($video_meta['what_we_did']) ? $video_meta['what_we_did'] : array();
			...
			<div class="wrap">
				...
				<table>
					...
					<tr>
						...
						<td>
							<label><input type="checkbox" name="sprinkle_video_meta[what_we_did][]" <?php if( in_array('strategy', $what_we_did) ) echo 'checked="checked" '; ?>value="strategy" />Strategy</label><br />
							<label><input type="checkbox" name="sprinkle_video_meta[what_we_did][]" <?php if( in_array('production', $what_we_did) ) echo 'checked="checked" '; ?>value="production" />Production</label><br />
							<label><input type="checkbox" name="sprinkle_video_meta[what_we_did][]" <?php if( in_array('delivery', $what_we_did) ) echo 'checked="checked" '; ?>value="delivery" />Delivery</label></td>
					</tr>
					<tr>
						<td><label for="what_we_did_description">What We Did Description:</label></td>
						<td><textarea name="sprinkle_video_meta[what_we_did_description]" id="what_we_did_description"><?php echo_test('what_we_did_description', $video_meta) ?></textarea>
					</tr>
					<tr>
					...
					<tr>
						<td><label for="video_testimonial">Testimonial Text:</label></td>
						<td><textarea name="sprinkle_video_meta[video_testimonial]" id="video_testimonial"><?php echo_test('video_testimonial', $video_meta); ?></textarea>
					</tr>
					<tr>
						<td><label for="testimonial_image_id">Testimonial Image ID</label></td>
						<td><input type="text" name="sprinkle_video_meta[testimonial_image_id]" id="testimonial_image_id" value="<?php echo_test('testimonial_image_id', $video_meta) ?>" />
					</tr>
				</table>
			</div>
	...
	switch( get_post_type($post_id) ) {
		...
		case 'video' :
						...
						if( isset($_POST['sprinkle_video_meta']) )
							update_post_meta($post_id, '_video_meta', bb_sanitize_data($_POST['sprinkle_video_meta']));
